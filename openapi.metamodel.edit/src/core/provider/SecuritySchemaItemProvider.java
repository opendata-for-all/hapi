	...
	protected void addInPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SecuritySchema_in_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SecuritySchema_in_feature", "_UI_SecuritySchema_type"),
				 CorePackage.Literals.SECURITY_SCHEMA__IN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.SECURITY_SCHEMA__SCOPES,
				 CoreFactory.eINSTANCE.createScope()));
	}
